...
Meteor.settings = {};                                                                                     // 6
                                                                                                          // 7
if (process.env.METEOR_SETTINGS) {                                                                        // 8
  try {                                                                                                   // 9
    Meteor.settings = JSON.parse(process.env.METEOR_SETTINGS);                                            // 10
  } catch (e) {                                                                                           // 11
    throw new Error("METEOR_SETTINGS are not valid JSON: " + process.env.METEOR_SETTINGS);                // 12
  }                                                                                                       // 13
}                                                                                                         // 14
                                                                                                          // 15
// Push a subset of settings to the client.                                                               // 16
if (Meteor.settings && Meteor.settings.public &&                                                          // 17
    typeof __meteor_runtime_config__ === "object") {                                                      // 18
  __meteor_runtime_config__.PUBLIC_SETTINGS = Meteor.settings.public;                                     // 19
}                                                                                                         // 20
                                                                                                          // 21
////////////////////////////////////////////////////////////////////////////////////////////////////////////
